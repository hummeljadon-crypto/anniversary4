...
$("#finishBtn").onclick = async () => {
  ...
  // Shot 2: she becomes even more evil.
  $("#finisherEyebrow").textContent = "Oh no";
  $("#finisherTitle").textContent = "She just got worse.";
  mary.classList.add("evil-form");
  audio.noise(.75,.06,500);
  audio.tone(125,48,1.0,"sawtooth",.08);
  flash();
  buzz([40,40,60,40,90]);

  await wait(1200);

  // Shot 3: slow-motion release.
